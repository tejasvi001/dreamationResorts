...
import {ResidentialRoomData} from "../../data.js"
...
const rooms = ResidentialRoomData.RoomGrid
const ClientsSayData=ResidentialRoomData.clientSay
...
export default function ResidentialRoom() {
  return (
    <div>
      <HeroSection title="Residential Rooms" backgroundImage="/bg.jpg" />
      <RoomOverview
      ...
      <ClientsSay ClientsSayData={ClientsSayData} />
