...
const HeroSection = () => {
  ...
  return (
    <div className="relative w-full h-screen bg-cover bg-center" style={{ backgroundImage: "url('/bg.jpg')" }}>
      {/* Overlay */}
      ...
      <div className="absolute top-0 w-full flex justify-between items-center p-5 md:px-16">
        ...
        <button className="border border-white text-white px-4 py-2 rounded-full">Get in Touch</button>
      </div>
