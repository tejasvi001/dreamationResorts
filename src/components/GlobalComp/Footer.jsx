        ...
        <div className='max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-3 gap-12 border-b border-white/10'>
          ...
          <div className='justify-start text-white text-lg lg:text-xl font-normal font-Lato leading-8 md:leading-[2vw]'>
            <p className='max-w-[550px] '>
              Dreamation Tourism & Hospitality Private Limited Hadbast No - 1037,
          ...
          <div className='flex flex-col'>
            <a
              href='Accomodation'
              className='hover:text-gray-300 transition-colors justify-start text-neutral-50 text-lg lg:text-xl font-normal font-Lato tracking-wide leading-8 md:leading-[2vw]'
            >
              Accommodations
            </a>
            <a
